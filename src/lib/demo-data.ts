...
export const demoBlocks: Block[] = [
  ...
  { id: 'blk-2', pageId: 'pg-3', type: 'video', title: 'Video: Deriving the Formula', content: { url: 'https://youtube.com/watch?v=example', duration: '12:34', watchThreshold: 80, chapters: [{ time: '0:00', title: 'Introduction' }, { time: '2:30', title: 'Completing the Square' }, { time: '6:15', title: 'Deriving the Formula' }, { time: '10:00', title: 'Examples' }] }, order: 2, isRequired: true, isCompleted: true },
  ...
  { id: 'blk-4', pageId: 'pg-3', type: 'whiteboard', title: 'Practice: Solve These', content: { prompt: 'Solve the equation: 2x² + 5x - 3 = 0', allowImage: true, rubric: '1. Show working (2 marks)\n2. Correct factorisation or formula usage (2 marks)\n3. Both solutions found (1 mark)' }, order: 4, isRequired: true, isCompleted: false },
  { id: 'blk-5', pageId: 'pg-3', type: 'reflection', title: 'Reflection: What did you learn?', content: { prompt: 'Reflect on what you learned about the quadratic formula. When would you use it instead of factorisation?', minWords: 50, rubric: 'Depth of reflection (3 marks)\nUse of specific examples (2 marks)', showPeerReflections: true, privacyMode: 'peer-gallery' }, order: 5, isRequired: false, isCompleted: false },
